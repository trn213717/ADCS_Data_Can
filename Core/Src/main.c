...
uint8_t m_x, m_y, m_z;
int datacheck =0;
int datacheck1 =0, datacheck2 =0,datacheck3 =0,datacheck4 =0,datacheck5 =0,datacheck6 =0,datacheck7 =0,datacheck8 =0,datacheck9 =0,datacheck10 =0,datacheck11 =0 ,datacheck12 =0,datacheck13 =0,datacheck14 =0,datacheck15 =0,datacheck16 =0;
...
//			memcpy(&hexValue, &floatValue, sizeof(floatValue));
		    ...
		    Txheader.IDE= CAN_ID_STD;
		    Txheader.RTR=CAN_RTR_DATA;
		    Txheader.StdId=0x78; //id

//		HAL_CAN_AddTxMessage(&hcan1, &Txheader, Txdata, &txmailbox);
		    HAL_CAN_AddTxMessage(&hcan1, &Txheader, Txdata, &txmailbox);

}
void CAN_TXU(unsigned int CAN_ID, uint8_t a, uint8_t b , uint8_t c){               // unsigned int CAN_ID = 0x1A;
...
void Uart( unsigned int a,float b){
	char msg[30];
	char msg1[30];
	sprintf(msg," Sensor Id %x  , %0.4f ",a,b);
	strcat(msg, "\r\n");
	HAL_UART_Transmit(&huart2, (uint8_t*)msg, sizeof(msg), 100);
}
/* USER CODE END 4 */
